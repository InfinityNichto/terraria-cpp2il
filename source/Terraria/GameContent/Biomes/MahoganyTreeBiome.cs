...
namespace Terraria.GameContent.Biomes
{
	...
	public class MahoganyTreeBiome : MicroBiome
	{
		...
		[global::Cpp2ILInjected.CallAnalysis.Calls(Type = typeof(Actions.RemoveWall), Member = ".ctor", ReturnType = typeof(void))]
		...
		[global::Cpp2ILInjected.CallAnalysis.Calls(Type = typeof(ShapeBranch), Member = ".ctor", MemberParameters = new object[]
		{
			typeof(double),
			typeof(double)
		}, ReturnType = typeof(void))]
		[global::Cpp2ILInjected.CallAnalysis.Calls(Type = typeof(ShapeBranch), Member = "OutputEndpoints", MemberParameters = new object[] { typeof(List<Point>) }, ReturnType = typeof(ShapeBranch))]
		...
		[global::Cpp2ILInjected.CallAnalysis.Calls(Type = typeof(ShapeRoot), Member = ".ctor", MemberParameters = new object[]
		{
			typeof(double),
			typeof(double),
			typeof(double),
